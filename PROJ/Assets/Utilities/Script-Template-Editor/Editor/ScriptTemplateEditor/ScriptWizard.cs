...
namespace ScriptTemplateEditor {
    public class ScriptWizard : EditorWindow {
        ...
        private static event Action<TextAsset> OnCreateTemplate;
        ...
        public static void OpenWindow(Rect parentWindowRect, Action<TextAsset> onCreateTemplateCallback) {
            ...
            OnCreateTemplate += onCreateTemplateCallback;
        }
