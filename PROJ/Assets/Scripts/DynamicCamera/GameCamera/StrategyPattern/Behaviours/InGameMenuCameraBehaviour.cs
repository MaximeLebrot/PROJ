...
public class InGameMenuCameraBehaviour : BaseCameraBehaviour {
    ...
    public override void EnterBehaviour() => menuRotation = Quaternion.Inverse(Quaternion.LookRotation(target.position - thisTransform.position));
